...
import OcrImage1 from './captionImages/Image1.png';
import OcrImage2 from './captionImages/Image2.png';
import OcrImage3 from './captionImages/Image3.png';
...
export const Imagecaptions = () => {
    ...
    const pageTitle = "Generate Image Captions";
    ...
    const describeImage = async () => {
        ...
        try {
            const result = await computerVisionClient.analyzeImageInStream(uint8Array, { visualFeatures: ['Description'] });
            console.log("The result is:", result);
            setAnalysis({ ...result });

            const { tags, ...descriptionWithoutTags } = result.description;
            setJsonText({ ...result, description: descriptionWithoutTags });
            setLoader(false);
        } catch (err) {
                                                ...
                                                <div className="d-flex">
                                                    <div className={`tab-content h-60vh ${Texttospeech['tab']}`} id="myTabContent">
                                                        <div className="tab-pane fade overflow-scroll h-75 show active p-3" id="table" role="tabpanel" aria-labelledby="table-tab">
                                                            {analysis && analysis.description && analysis.description.captions ? (
                                                                <table className='table'>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>{analysis.description.captions[0].text}</td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            ) : (
