...
import pdfSample1 from '../DocumentSamples/invoice.pdf';
import pdfSample2 from '../DocumentSamples/InvoiceSample1.pdf';
...
export default function InvoiceOcr() {
  ...
  const handleSample = async  (id) => {
    ...
    if(id == 1)
    {
      const response = await fetch(pdfSample1);
    ...
    {
      const response = await fetch(pdfSample2);
      const pdfData = await response.blob();
  ...
  async function startAnalyzingDoc(img) {
    ...
    const poller = await client.beginAnalyzeDocument('prebuilt-invoice',img) ;
                  ...
                  <div className="card border-0 rounded-0">
                    ...
                    >
                      ...
                      <div className='form-group my-3'>
                        <label className='form-label text-dark mb-2'>Please Upload Pdf</label>
                        <div className='card text-center w-25 p-2'>
                            <div className='file file--disabled'>
                                ...
                                {uploadImage == '' ? (
                                    <i className="fas fa-file-pdf display-1"></i>
                                    ) :(
                                      <i className="fas fa-file-pdf display-1 text-dark"></i>
                                )}
                                <p>
                                <small>
                                Upload File
                                ...
                                <input id='input-file' onChange={handleImage} type='file' accept=".pdf" />
                            </div>
                        </div>
                      </div>
