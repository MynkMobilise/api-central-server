...
export default function DocumentStudioDashbaord() {
    //Variables

    const pageTitle = "Document Studio";

    //Array Creation
  const services = [
    { 
      title: "Invoices OCR",
      subTitle: "Use your own audio recordings to create a distinct, one-of-a-kind voice for your text to speech apps.",
      link: "invoice-ocr",
    ...
    { 
      title: "General Document OCR",
      subTitle: "Use your own audio recordings to create a distinct, one-of-a-kind voice for your text to speech apps.",
      link: "general-doc-ocr",
      image: "assets/img/blue-pan.svg",
      batch: "0 Credits",
    },
    { 
