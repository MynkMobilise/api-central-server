...
function Facestudiodashboard() {

    //Variables

    const pageTitle = "Face Studio";

    //Array Creation
  const services = [
    { 
      title: "Detect Face Have Mask",
      subTitle: "Detect the location of one or more human faces in images, along with attributes such as pose, face mask and facial landmarks.",
      link: "face_api",
...
export default Facestudiodashboard