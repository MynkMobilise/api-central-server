...
export default function GSTNoVerify() {
  ...
  function validateForm() {
    const newErrors = {};
    if (!panForm.gstin) {
      newErrors.gstin = "GST no is required.";
    }
  ...
  function submit(event) {
    ...
    OcrServices.postGstInDetails(params).then(
      (res) => {
        console.log(res);
        setTimeout(() => {
                              ...
                              {outputJson != "" ? (
                                <table className="table">
                                  ...
                                  <tbody>
                                    <tr>
                                      <td>GSTIN Status:</td>
                                      <td>{outputJson.gstin_status}</td>
                                    </tr>
                                    <tr>
                                      <td>Legal Name of Business:</td>
                                      <td>{outputJson.legal_name}</td>
                                    </tr>
                                    <tr>
                                      <td>Constitution of Business:</td>
                                      <td>
                                        {outputJson.constitution_of_business}
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>Date of Registration:</td>
                                      <td>{outputJson.date_of_registration}</td>
                                    </tr>
                                    <tr>
                                      <td>Principal Place of Business:</td>
                                      <td>
                                        {JSON.stringify(
                                          outputJson.principal_place_of_business_fields
                                        )}
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>Nature of Business Acitivty:</td>
                                      <td>
                                        {outputJson.nature_of_business_activity.toString()}
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>Trade Name:</td>
                                      <td>{outputJson.trade_name}</td>
                                    </tr>
                                    <tr>
                                      <td>Taxpayer Type:</td>
                                      <td>{outputJson.taxpayer_type}</td>
                                    </tr>
                                    <tr>
                                      <td>Centre Jurisdiction:</td>
                                      <td>{outputJson.centre_jurisdiction}</td>
                                    </tr>
                                    <tr>
                                      <td>Centre Jurisdiction Code:</td>
                                      <td>
                                        {outputJson.centre_jurisdiction_code}
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>Date of Cancellation:</td>
                                      <td>{outputJson.date_of_cancellation}</td>
                                    </tr>
                                    <tr>
                                      <td>GSTIN:</td>
                                      <td>{outputJson.gstin}</td>
                                    </tr>
                                    <tr>
                                      <td>Last Updated Date:</td>
                                      <td>{outputJson.last_updated_date}</td>
                                    </tr>
                                    <tr>
                                      <td>Source:</td>
                                      <td>{outputJson.source}</td>
                                    </tr>
                                    <tr>
                                      <td>State Jurisdiction Code:</td>
                                      <td>
                                        {outputJson.state_jurisdiction_code}
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>Status:</td>
