...
export default function McaCompanyVerification() {
  ...
  const [rawJson, setJsonOuputRaw] = useState([]);

  function validateForm() {
    const newErrors = {};
    if (!panForm.cin) {
      newErrors.cin = "CIN no is required.";
    }
  ...
  const runSamples = () => {
    panForm.cin = 'L27100MH1907PLC000260';
  ...
  function submit(event) {
    ...
    OcrServices.postMcaCompantDetails(params).then(
      (res) => {
        console.log(res);
        setTimeout(() => {
                              ...
                              {outputJson != "" ? (
                                <table className="table">
                                  ...
                                  <tbody>
                                    <tr>
                                      <td>Name:</td>
                                      <td>{outputJson.company_name}</td>
                                    </tr>
                                    <tr>
                                      <td>Status:</td>
                                      <td>
                                        {outputJson.whether_listed_or_not}
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>Authorised Capital:</td>
                                      <td>{outputJson.authorised_capital}</td>
                                    </tr>
                                    <tr>
                                      <td>Category:</td>
                                      <td>{outputJson.company_category}</td>
                                    </tr>
                                    <tr>
                                      <td>Official Email-ID:</td>
                                      <td>{outputJson.email_id}</td>
                                    </tr>
                                    <tr>
                                      <td>Reg. Address:</td>
                                      <td>{outputJson.registered_address}</td>
                                    </tr>
                                    <tr>
                                      <td>Directors:</td>
                                      <td>
                                        {JSON.stringify(outputJson.directors)}
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>Date of Balance Sheet:</td>
                                      <td>
                                        {outputJson.date_of_balance_sheet}
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>LLP Name:</td>
                                      <td>{outputJson.llp_name}</td>
                                    </tr>
                                    <tr>
                                      <td>No. of Partners:</td>
                                      <td>{outputJson.no_of_partners}</td>
                                    </tr>
                                    <tr>
                                      <td>No. of Members:</td>
                                      <td>{outputJson.number_of_members}</td>
                                    </tr>
                                    <tr>
                                      <td>Paid up capital:</td>
                                      <td>{outputJson.paid_up_capital}</td>
                                    </tr>
                                    <tr>
                                      <td>Related companies:</td>
                                      <td>{outputJson.related_companies}</td>
                                    </tr>
                                    <tr>
                                      <td>Reg. Number:</td>
                                      <td>{outputJson.registration_number}</td>
                                    </tr>
                                    <tr>
                                      <td>Date of last AGM:</td>
                                      <td>{outputJson.date_of_last_agm}</td>
                                    </tr>
                                    <tr>
                                      <td>LLP Pin:</td>
                                      <td>{outputJson.llpin}</td>
                                    </tr>
                                    <tr>
                                      <td>No. of Designated Partners:</td>
                                      <td>
                                        {outputJson.no_of_designated_partners}
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>ROC Code:</td>
                                      <td>{outputJson.roc_code}</td>
                                    </tr>
                                    <tr>
                                      <td>Sub Category:</td>
                                      <td>{outputJson.company_subcategory}</td>
                                    </tr>
                                  </tbody>
                                </table>
                              ) : (
