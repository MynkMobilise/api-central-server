...
import aadharImageFront from './aadharImages/aadhar_front.png';
import aadharImageBack from './aadharImages/aadhar_back.png';

export default function AadharOcr() {
  const pageTitle = "Aadhaar OCR";
  ...
  const [ocrInfo, setOcrMoreInfo] = useState(
    "Extracts data from Aadhaar cards instantly and accurately. IDfy’s Aadhaar Card OCR API extracts data from an image of an Aadhaar Card. It accurately auto-fills this data in the right fields for a quicker & errorless form-filling experience."
  );
  ...
  const runAnalyzer = () => {
    ...
    OcrServices.getAadhaarOcr(params).then((res) => {
      console.log(res);
      setJsonOuput(res);
      setLoader(false);
    });
  ...
  const runSamples = () => {
    handleImageClick(aadharImageFront);
    handleImageClick2(aadharImageBack);
  }
      ...
      <div className={`container-fluid ${Texttospeech["text-wrapper"]}`}>
        ...
        <div className="card border-0 bg-light">
          ...
          <div className={`${Texttospeech["bdr"]}`}>
            ...
            <p
              className={`mb-0 px-3 py-2 pb-3 pt-3 ${Texttospeech["summary"]} font-weight-thick text-gray`}
            >
              {ocrInfo}
            </p>
                  ...
                  <div className={`col-md-6 pr-0 ${Texttospeech["bdr-btw"]}`}>
                    <div className="card border-0 rounded-0">
                      ...
                      >
                        ...
                        <div className="card-body p-3 h-40vh">
                        ...
                        <div className='col-4 my-3'>
                          ...
                          <div className='col-4 my-3 d-none'>
                            <div className='card text-center w-100 p-2'>
                              <div className='file file--disabled' onClick={() => handleImageClick(aadharImageFront)}>
                                <label className='mb-0 w-100'>Aadhar Front
                                  <img style={{ height: "100px" }} className='img-fluid' src={aadharImageFront} alt="Preview" />
                                </label>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className='col-4 my-3 d-none'>
                            <div className='card text-center w-100 p-2'>Aadhar Back
                              <div className='file file--disabled' onClick={() => handleImageClick2(aadharImageBack)}>
                                <label className='mb-0 w-100'>
                                  <img style={{ height: "100px" }} className='img-fluid' src={aadharImageBack} alt="Preview" />
                                </label>
                              </div>
                            </div>
                          </div>
