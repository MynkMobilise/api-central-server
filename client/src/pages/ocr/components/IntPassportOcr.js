...
import internationalPassportImage from './internationalPassportImages/internation_image.jpeg';

export default function IntPassportOcr(){
    const pageTitle = "International Passport OCR";
    ...
    const [ocrInfo, setOcrMoreInfo] = useState(
        "Extracts data from International Passport instantly and accurately. International Passport OCR API extracts data from an image of the International Passport. It accurately auto-fills this data in the right fields for a quicker & errorless form-filling experience."
    );
  ...
  const runAnalyzer = () => {
    ...
    OcrServices.getInternationalPassport(params).then((res) => {
      console.log(res);
      setJsonOuput(res);
      setLoader(false);
    //   setTimeout(() => {
  ...
  const handleImageClick = () => {
    setBase64String(internationalPassportImage);
    simulateFileUpload(internationalPassportImage);
  };
                        ...
                        <div className='col-4 my-3'>
                          ...
                          <div className='col-4 my-3 d-none'>
                            <div className='card text-center w-100 p-2'>
                              <div className='file file--disabled' onClick={() => handleImageClick(internationalPassportImage)}>
                                <label className='mb-0 w-100'>
                                  <img style={{ height: "100px" }} className='img-fluid' src={internationalPassportImage} alt="Preview" />
                                </label>
                              </div>
                            </div>
                          </div>
